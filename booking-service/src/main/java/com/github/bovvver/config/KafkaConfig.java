...
class KafkaConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, NegotiationStartedFailureIntegrationEvent> negotiationStartedFailureFactory() {
        return buildFactory(NegotiationStartedFailureIntegrationEvent.class);
    }
